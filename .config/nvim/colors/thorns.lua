...
hi("uiuaRed",             { fg = c.red    })
hi("uiuaOrange",          { fg = c.pink   })
hi("uiuaYellow",          { fg = c.yellow })
hi("uiuaBeige",           { fg = c.green  })
hi("uiuaGreen",           { fg = c.green  })
hi("uiuaAqua",            { fg = c.cyan   })
hi("uiuaBlue",            { fg = c.blue   })
hi("uiuaIndigo",          { fg = c.blue   })
hi("uiuaPurple",          { fg = c.purple })
hi("uiuaPink",            { fg = c.pink   })
hi("uiuaLightPink",       { fg = c.pink   })
hi("uiuaFaded",           { fg = c.grey   })
hi("uiuaForeground",      { fg = c.text   })
hi("uiuaForegroundDark",  { fg = c.grey   })
hi("uiuaForegroundLight", { fg = c.text   })
